	...
	return (
		<>
			<div className="bg-gray-50">
				<div className="xl:flex xl:justify-end py-10">
					<div className="container sm:mx-auto">
						<div className="block xl:flex justify-between xl:items-center lg:items-center md:flex">
							<div className="w-11/12 xl:w-4/12 mx-auto xl:mx-0 md:w-5/12">
								<h1 className="text-gray-800 text-3xl font-extrabold mb-3 md:pt-12 pt-0 xl:pt-0">
									Sign Up for Product Updates
								</h1>
								<p className="text-lg text-gray-600 mb-6">
									Sign Up for our weekly newsletter to get the latest news
								...
								<div className="flex w-full flex-wrap">
									<div className="w-full">
										...
										<button
											type="submit"
											className="focus:outline-none bg-gray-700 hover:bg-gray-600 text-white text-base w-full py-3 px-6 rounded"
										>
							...
							<div className="w-11/12 xl:w-5/12 mx-auto xl:mx-0 mt-8 xl:mt-0 flex justify-end md:w-5/12 bg-gray-100 relative py-20">
								<div className="h-4/5 w-4/5">
									<img
										src="https://images.pexels.com/photos/441795/pexels-photo-441795.jpeg?auto=compress&cs=tinysrgb&w=600"
										alt="pic"
								...
								<div className="absolute bottom-0 right-0 pb-2 pr-2 z-0">
									...
									>
										<g fill="#A1AEB5" fillRule="evenodd">
